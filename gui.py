...
class AnalysisPage(QWidget):
    ...
    def __init__(self) -> None:
        ...
        self.advanced_button = QPushButton("Advanced analysis")
        self.quarantine_button = QPushButton("Quarantine placeholder")
        self.terminate_button = QPushButton("Terminate placeholder")
        ...
        action_row.addWidget(self.quarantine_button)
